...
#live 9.5
    ...
    """"
    Reorders VST folders to the top of Places and gets rid of 'Current Project'
    """
    def query(self, browser):
        return list(browser.user_folders) + [browser.user_library, browser.packs] + list(browser.legacy_libraries) + [browser.current_project]
